...
class Args():
    def __init__(self):
        ...
        self.hidden_size_rnn = int(256/self.parameter_shrink) # hidden size for main RNN
        ...
        self.batch_ratio = 16 # how many batches of samples per epoch, default 32, e.g., 1 epoch = 32 batches
        ...
        self.graph_save_path = self.dir_input+'synthetic_data/'
        ...
        self.patience = 25             # number of epochs to wait after no improvement
        self.early_stop_metric = 'loss'  # or 'bce', 'kl', or anything else you want
